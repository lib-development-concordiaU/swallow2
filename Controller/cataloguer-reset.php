...
if(isset($_GET['id'])){
    ...
    ini_set('SMTP', 'smtp.concordia.ca');
        ...
        <!DOCTYPE html PUBLIC '-//W3C//DTD HTML 4.01 Transitional//EN' 'http://www.w3.org/TR/html4/loose.dtd'>
            <html>
                <body>
                    ...
                    <p>Welcome to Swallow</p>
                    <p>This is your login information:</p>
                    <p> <b>URL: <a href='https://library.concordia.ca/apps/swallow2/'>https://library.concordia.ca/apps/swallow2/</a></p>
                    <p> You can login with ypur concordia netname and password<p>
                    <br />
                <body>
            </html>
        ";
